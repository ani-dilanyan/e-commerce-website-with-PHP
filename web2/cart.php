...
<div class="container-fluid">
  ...
  <button type="button" class="btn btn-success mb-1"><a href="shop.php" id="checkout">Continue shopping</a></button>
  <button type="button" class="btn btn-success mb-1"><a href="payment.php" id="checkout">Checkout</a></button>
</div>
