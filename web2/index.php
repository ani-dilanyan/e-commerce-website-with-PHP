...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100 h-25" src="img/fruits.jpg" alt="First slide">
      <p class="w-25 position-absolute text-light d-none d-lg-block" style="bottom: 100px; left: 400px; font-size: 25px"><strong>Special offer!</strong><br>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
    ...
    <div class="carousel-item">
      <img class="d-block w-100 h-25" src="img/dairy.jpg" alt="Third slide">
      <p class="w-25 position-absolute text-light d-none d-lg-block" style="bottom: 100px; left: 400px; font-size: 25px"><strong>Special offer!</strong><br>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
      tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
    </div>
    <div class="carousel-item">
      <img class="d-block w-100 h-25" src="img/meat.jpg" alt="Third slide">
      <p class="w-25 position-absolute text-light d-none d-lg-block" style="bottom: 100px; left: 400px; font-size: 25px"><strong>Special offer!</strong><br>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
      tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
    </div>
    <div class="carousel-item">
      <img class="d-block w-100 h-25" src="img/bakery.jpg" alt="Third slide">
      <p class="w-25 position-absolute text-light d-none d-lg-block" style="bottom: 100px; left: 400px; font-size: 25px"><strong>Special offer!</strong><br>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
      tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
    </div>
  </div>
...
<h3 class="m-0 p-3 font-weight-bold alert-warning ">Special offers</h3>
<div class="row m-0">
...
<h3 class="mt-3 m-0 p-3 font-weight-bold alert-warning">Popular</h3>
<div class="row m-0">
  ...
  <a href="product.php" class="text-dark" style="text-decoration:none" >
    <div class="card col-12 col-sm-6 col-md-4 col-lg-3 p-1">
      ...
      <div class="card-body">
        ...
        <p class="card-text pl-4">$13/kg</p>
        <a href="cart.php" class="btn btn-success ml-4 mt-2">Add to Cart</a>
      </div>
    </div>
  </a>
  ...
  <a href="product.php" class="text-dark" style="text-decoration:none" >
    <div class="card col-12 col-sm-6 col-md-4 col-lg-3 p-1  d-md-none d-lg-block">
      ...
      <div class="card-body">
        <h5 class="card-title pl-4">Lavash</h5>
        <p class="card-text pl-4">$1/kg</p>
        <a href="cart.php" class="btn btn-success ml-4 mt-2">Add to Cart</a>
      </div>
    </div>
  </a>
  ...
  <a href="product.php" class="text-dark" style="text-decoration:none" >
    <div class="card col-12 col-sm-6 col-md-4 col-lg-3 p-1">
      ...
      <div class="card-body">
        ...
        <p class="card-text pl-4">$0.5/kg</p>
        <a href="cart.php" class="btn btn-success ml-4 mt-2">Add to Cart</a>
      </div>
    </div>
  </a>
  ...
  <a href="product.php" class="text-dark" style="text-decoration:none" >
    <div class="card col-12 col-sm-6 col-md-4 col-lg-3 p-1">
      ...
      <div class="card-body">
        <h5 class="card-title pl-4">Bread</h5>
        <p class="card-text pl-4">$1.25/kg</p>
        <a href="cart.php" class="btn btn-success ml-4 mt-2">Add to Cart</a>
      </div>
    </div>
  </a>
</div>
<h3 class="mt-3 m-0 p-3 font-weight-bold alert-warning ">Today's recepie</h3>
<div class="embed-responsive embed-responsive-16by9">
  <iframe src="https://www.youtube.com/embed/AEUBQ7Ieub0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="height: 700px"></iframe>
</div>
